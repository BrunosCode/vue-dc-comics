...
<div class="c-collection l-container">
    <h2 class="c-collection">Current Series</h2>
    <div class="c-collection__comics l-row l-row--spacebetween l-wrap">
        <Comic v-for="(volume, i) in pippo" :key="i" :comic-data="volume.thumb"/>
    </div>
